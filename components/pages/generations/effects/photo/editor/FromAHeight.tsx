...
import { FromAHeightPrompt } from "@/lib/utils";
import { formSchema, FormValues } from "@/lib/validation";

export const FromAHeight = () => {
  ...
  return (
    <section className="max-w-3xl mx-auto">
      ...
      <Card className="bg-transparent shadow-none border-none mt-8 md:mt-0">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 title-text">{t("FromAHeight")}</CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...form}>

...
import { CreateTtModelDialog } from "@/components/shared/create/CreateTtModelDialog";
        ...
        <section className="section-padding container mx-auto max-w-6xl min-h-screen">
            <div className="flex flex-col sm:flex-row items-center justify-between mt-4 mb-6 gap-4">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-2 w-full sm:w-auto">
                    ...
                    <Link href="/create/models/ttapi/magic-photo" className="flex-1 sm:flex-none">
            ...
            <CreateTtModelDialog open={isDialogOpen} onOpenChange={setIsDialogOpen} modelToEdit={modelToEdit} />
        </section>
    );
};
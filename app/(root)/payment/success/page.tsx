      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6">
        <div className="flex flex-col items-center space-y-4">
          ...
          <h1 className="title-text text-center">
            {t("Success.Title") || "Платеж успешно выполнен!"}
          </h1>
          <p className="text-muted-foreground text-center max-w-md">
            {t("Success.Description") || "Ваш платеж был успешно обработан. Средства зачислены на ваш баланс."}
          </p>
          {payment && (
        ...
        <div className="flex flex-col gap-4 w-full max-w-md">
          <Button
            ...
            variant="outline"
          >
            {t("Success.ViewTransactions") || "Посмотреть транзакции"}
          </Button>
          <Button
            onClick={() => router.push("/")}
            className="w-full"
          >
            {t("Success.BackToHome") || "Вернуться на главную"}
          </Button>
        </div>
      </div>
    </div>

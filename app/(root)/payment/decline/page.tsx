      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6">
        <div className="flex flex-col items-center space-y-4">
          ...
          <h1 className="title-text text-center">
            {t("Decline.Title") || "Платеж отклонен"}
          </h1>
          <p className="text-muted-foreground text-center max-w-md">
            {t("Decline.Description") || "Ваш платеж был отклонен банком или платежной системой. Пожалуйста, проверьте данные карты и попробуйте еще раз."}
          </p>
          {payment && (
        ...
        <div className="flex flex-col gap-4 w-full max-w-md">
          ...
          <Button
            ...
            variant="outline"
          >
            {t("Decline.BackToHome") || "Вернуться на главную"}
          </Button>
        </div>
      </div>
    </div>
